...
const updateUserPofileData =  async ()=> {
  try {
    ...
    const {data} = await axios.post(backendUrl + '/api/user/update-pofile',formData,{headers:{token}})
    ...
    <div className='max-w-ig flex flex-col gap-2 text-sm'>
      {
        ...
        <div>
          <div>
            {
              isEdit
              ?<button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all'  onClick={updateUserPofileData}> Save information</button>
